...
<link rel="stylesheet" href="http://cdn.bootcss.com/bootstrap/3.3.0/css/bootstrap.css">
 <link rel="stylesheet" href="${ctx}/statics/js/common/css/layui.css" media="all">
<style type="text/css">
      *{
            margin: 0px;
            padding: 0px;
	...
	<div class="sou">
        ...
        <c:if test="${sessionScope.easybuyUserLogin!=null}">
          ...
          <c:if test="${sessionScope.easybuyUserLogin!=null && sessionScope.easybuyUserLogin.type==1}">
            <span class="fl">|&nbsp;<a href="${ctx }/spring/user/menuTree">后台管理</a>&nbsp;</span>
          </c:if>
          <!-- 登陆成功出现注销功能！没登录没有。。 -->
          <c:if test="${sessionScope.easybuyUserLogin!=null}">
...
<script type="text/javascript" src="${ctx}/statics/js/common/bootstrap.js"></script>
<script src="${ctx}/statics/js/common/layui.js"></script>
</body>
</html>